      ...
      <div className="page-content fade-in" style={{ paddingBottom: 32 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
          <div className="card" style={{ textAlign: 'center' }}>
            ...
            <div style={{ color: '#000000', fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: 6 }}>Questionnaire</div>
            <div style={{ fontSize: 28, fontWeight: 900, color: '#F43F5E', margin: '6px 0' }}>{a.anxietyScore}%</div>
            <div style={{ color: '#000000', fontSize: 12 }}>Anxiety Score</div>
          </div>
          <div className="card" style={{ textAlign: 'center' }}>
            <div style={{ fontSize: 28 }}>📸</div>
            <div style={{ color: '#000000', fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.5px', marginTop: 6 }}>Facial Emotion</div>
            <div style={{ fontSize: 20, fontWeight: 800, color: '#F59E0B', margin: '8px 0' }}>{a.emotion}</div>
            <div style={{ color: '#000000', fontSize: 12 }}>Detected State</div>
          </div>
        </div>
