  ...
  return (
    <div className="screen">
      ...
      <div className="page-content content-padded" style={{ overflowY: 'auto', flex: 1 }}>
        ...
        <div style={{ color: '#000000', fontSize: 13, fontWeight: 600, marginBottom: 10 }}>
          ...
          patients.map(p => (
            <div key={p.id} className="list-item" onClick={() => navigate(`/patients/${p.id}`)}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ color: '#000000', fontSize: 13 }}>{p.age} yrs · {p.gender}</div>
                <div style={{ color: '#000000', fontSize: 12 }}>Added {p.createdAt}</div>
              </div>
